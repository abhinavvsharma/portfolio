...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Abhinav Sharma.</h2>;
  const three = <h3 className="big-heading">I am a Master's in CS student.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="mailto:abhinav.sharma.12@outlook.com"
      target="_blank"
      rel="noreferrer">
      Get in Touch!
    </a>
